...
class Scan:
    ...
    def create_task(self, name, target_id):
        response = self.gmp.create_task(name=name, config_id='daba56c8-73ec-11df-a475-002264764cea', target_id=target_id, scanner_id='08b69003-5fc2-4037-a479-93b440211c73')
